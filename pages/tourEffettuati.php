        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-6 ">
                    ...
                    <?php
                        $sql = "SELECT * FROM ordine WHERE utente = '$utente'";
                        ...
                        if($result -> num_rows > 0){
                            while($row = $result -> fetch_assoc()){
                                ...
                                <div class="single_tour_package">
                                    ...
                                    $sql2 = "SELECT * FROM Tour WHERE id = $idTourNome";
                                    ...
                                    $sql3 = "SELECT * FROM ordine WHERE utente = '$utente'";
                                    $result3 = $conn -> query($sql3);
                                    if($result3 -> num_rows > 0){
                                        while($row = $result3 -> fetch_assoc()){
                                    echo '
                                        <p><b>'.$row["dataInizio"].'</b></p>
                                        <p>'.$row["cittaPartenza"].'</p>
                                       
                                        <a href="tour.php?id='.$row['tour'].'&viaggiInCorso=1" class="btn1">Scopri di più</a>
                                    </div>
                                </div>';    
                            }
                        }   
                ...
                <div class="col-lg-5 col-xl-3 offset-lg-1 col-sm-6">
                    <div class="tour_pack_content">
                        ...
                        <h2>Elenco di tutti i tour effettuati o iniziati</h2>
                        <p>Questi sono tutti i tour iniziati o finiti da te.Per avere informazioni aggiuntive sui vari tour schiacciare "Scopri di più" sulla scheda dello stadio</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tutti i diritti riservati | Realizzato da Tascio, Corne e Dawood</a>
